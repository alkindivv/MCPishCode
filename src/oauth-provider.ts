...
function formHtml(params: {
  ...
  const scopeText = params.scopes.length > 0 ? params.scopes.join(" ") : "mcpishcode";
  const resourceText = params.resource?.href ?? "MCPishCode MCP endpoint";
...
<html lang="en">
  <head>
    ...
    <title>Connect MCPishCode</title>
    <style>
...
${hiddenFields}
        ...
        <button type="submit">Authorize MCPishCode</button>
      </form>
    </main>
  </body>
</html>`;
