...
- a public HTTPS URL that forwards to the local MCPishCode server

MCPishCode does not create the public tunnel for you. Use Cloudflare Tunnel,
...
Choose the folders ChatGPT is allowed to open through MCPishCode. Keep this
narrow.
...
When ChatGPT, Claude, or another MCP client connects, MCPishCode shows an Owner
...
If you are developing MCPishCode itself instead of using the published package:
