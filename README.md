<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/alkindivv/MCPishCode/main/docs/assets/mcpishcode-logo-light.png" alt="MCPishCode logo" width="140">
  </picture>
</p>

<h1 align="center">MCPishCode</h1>

<p align="center">Bring a Codex-style coding workflow to ChatGPT.</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@alkindivv/mcpishcode"><img alt="npm" src="https://img.shields.io/npm/v/%40waishnav%2Fmcpishcode?style=flat-square" /></a>
  <a href="https://github.com/alkindivv/MCPishCode/actions/workflows/ci.yml"><img alt="CI" src="https://img.shields.io/github/actions/workflow/status/alkindivv/MCPishCode/ci.yml?style=flat-square&branch=main" /></a>
  <a href="https://github.com/alkindivv/MCPishCode/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/npm/l/%40waishnav%2Fmcpishcode?style=flat-square" /></a>
</p>

[![MCPishCode connected to ChatGPT](https://raw.githubusercontent.com/alkindivv/MCPishCode/main/docs/assets/mcpishcode-screenshot.png)](https://raw.githubusercontent.com/alkindivv/MCPishCode/main/docs/assets/mcpishcode-screenshot.png)
...
<p>
  MCPishCode is open to new sponsors.
...
```bash
npm install -g @alkindivv/mcpishcode
```
...
During setup, MCPishCode asks for:
...
> [!NOTE]
> Using MCPishCode as an MCP connector isn't against OpenAI's Usage Policies — it's
...
> MCPishCode. Don't point it at anything that would violate your provider's terms.
...
MCPishCode supports Linux, macOS, and Windows environments with a Bash-compatible
shell.
...
- [Setup Guide](https://github.com/alkindivv/MCPishCode/blob/main/docs/setup.md)
- [ChatGPT Coding Workflow](https://github.com/alkindivv/MCPishCode/blob/main/docs/chatgpt-coding-workflow.md)
- [Configuration Reference](https://github.com/alkindivv/MCPishCode/blob/main/docs/configuration.md)
- [Native File Download](https://github.com/alkindivv/MCPishCode/blob/main/docs/artifact-exchange.md)
- [Security Model](https://github.com/alkindivv/MCPishCode/blob/main/docs/security.md)
- [Troubleshooting Gotchas](https://github.com/alkindivv/MCPishCode/blob/main/docs/gotchas.md)
...
MCPishCode is one attempt to fast-forward that future: a way for MCP-capable
hosts like ChatGPT and Claude to work directly with local project files through
explicit, inspectable tools.

## Built by alkindivv

I'm alkindivv, I like building opinionated products and tools, and MCPishCode is one example of that.
